...
<html lang="en">
	...
	<body>
		<header>
			...
			<a id="lang" href="/portfolio/" hreflang="en">English</a>
		</header>
		<main>	
			<section id="about">
				<h2 class='sectionTitle'>Sobre Mim</h2>
				<div class="row">
						...
						<div class="timeline">
						    ...
						    <ul>
						      <li>
						        ...
						        <p>Aprendi desenvolvimento de softwares, além de instalação e uso de sistemas operacionais diversos e seus aplicativos, manutenção de hardware, projetos de rede e implantações.</p>
						        <time>2009 – 2011</time>
						      </li>
						    </ul>
						    ...
						    <ul>
						      <li class="active">
						        ...
						        <p>Estou aprendendo a identificar, analisar, projetar, implementar, implantar, avaliar e manter sistemas eficientes e seguros para a Internet, com ênfase em software livre e com base em metodologias e técnicas apropriadas, seguindo preceitos éticos e científicos.</p>
